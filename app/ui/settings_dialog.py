...
class SettingsDialog(QDialog):
    ...
    def _create_placeholder_page(self, title: str) -> QWidget:
        """Create a settings page. For Security/Privacy, includes danger zone."""
        page = QWidget()
        layout = QVBoxLayout(page)
        layout.setContentsMargins(0, 0, 0, 0)
        layout.setSpacing(24)
        ...
        # Add Danger Zone for Security page
    ...
    def _confirm_reset(self):
        ...
        if reply == QMessageBox.Yes:
            ...
            second_reply = QMessageBox.critical(
                ...
                "Type 'RESET' to confirm (just click Yes for now):",
                QMessageBox.Yes | QMessageBox.No,
                QMessageBox.No
            )
    ...
    def _perform_reset(self):
        ...
        try:
            # Create a marker file that tells main.py to delete everything on next start
